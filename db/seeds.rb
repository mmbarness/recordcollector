...
data.each do |artist_object|
    ...
    "https://record-collector-dev.s3.amazonaws.com/albums/andy-stott-passed-me-by-album-photo.jpeg"
    idk = `#{artist_name}-#{album_title}-album-photo.jpeg`
    file = "andy-stott-passed-me-by-album-photo.jpeg"
    # photo_file_name = `#{artist_name}-#{album_title}-album-photo.jpeg`
    album.photo.attach(io: URI.open(album_url), filename: file)
end
#url = "https://record-collector-dev.s3.amazonaws.com/albums/andy-stott-passed-me-by-album-photo.jpeg"
#file = "andy-stott-passed-me-by-album-photo.jpeg"
#passed_me.photo.attach(io: URI.open(url), filename: file)
